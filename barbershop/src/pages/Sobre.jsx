...
const Sobre = () => {
  return (
    <section className="pt-11 bg-primary w-full">
      <div className="flex flex-col md:flex-row items-start px-4 md:px-10 pt-10 gap-8">
        <div className="flex-1">
          ...
          <p className="text-lg text-center sm:text-xl md:text-2xl font-bold text-text pb-8 max-w-full md:max-w-xl break-words">
        ...
        <div className="flex-1 flex mx-auto md:justify-end">
          <img
            src={imgCortes}
            alt="Foto dos cortes"
            className="ml-10 w-full max-w-xs sm:max-w-sm md:max-w-md h-auto rounded-lg"
          />
        </div>
      </div>
    </section>
